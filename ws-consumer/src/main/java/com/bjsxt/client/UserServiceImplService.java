 ...
 * 
 */
@WebServiceClient(name = "UserServiceImplService", targetNamespace = "http://impl.service.bjsxt.com/", wsdlLocation = "http://localhost:9999/ws?wsdl")
    ...
    extends Service
{
    ...
    private final static QName USERSERVICEIMPLSERVICE_QNAME = new QName("http://impl.service.bjsxt.com/", "UserServiceImplService");
    ...
    public UserServiceImpl getUserServiceImplPort() {
        return super.getPort(new QName("http://impl.service.bjsxt.com/", "UserServiceImplPort"), UserServiceImpl.class);
    }
    ...
    public UserServiceImpl getUserServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://impl.service.bjsxt.com/", "UserServiceImplPort"), UserServiceImpl.class, features);
    }
